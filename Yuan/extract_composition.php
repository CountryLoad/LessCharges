...
/***** local composition*****/
  ...
  function local_text($text){
    ...
    if($text_cost[1] < $text){
      $text_cost[0] = $text_cost[0] + 0.1 * ($text-$text_cost[1]);
    } else {
      $text_cost[0] = $text_cost[0];
    }
    return $text_cost;
  }
...
/***** national composition*****/  
  function national_compose($call, $data, $text){   
    $pkg_nc = new Pkg('4g全国组合', '4G', 'nc', 0,0,0,0,0.15,0.2,0.1);
...
/***** wopai *****/
 ...
 function get_wo($call, $data, $text){
   $pkg_wo[] = new Pkg();
   $pkg_wo[0] = new Pkg('1','4G', 'wo', 16,100,200,0,0.15,0.3,0.1,0);
   $pkg_wo[1] = new Pkg('1','4G', 'wo', 26,100,600,0,0.15,0.3,0.1,0);
   $pkg_wo[2] = new Pkg('1','4G', 'wo', 36,100,1024,0,0.15,0.3,0.1,0);
